...
config = {
    ...
    "accel_path": "Enter Path or Name to Acceleration Data",  # Path to the accelerometer data for creating combined data or classifying unlabeled data
    "reports_path": "Enter Path or Name to SelfReports Data",  # Path to the self-reports data
    "combined_data_path": "Enter Path or Name to Combined Data",  # Path to the combined data
    "features_data_path": "Enter Path or Name to Features Data",  # Path to the features data
    "model_path": "Enter Path or Name to Model File",  # Path to the trained model
    ...
    "selected_domains": None,  # Default: For Calculating every Domain, use 'None' / 'time_domain', 'spatial', 'frequency', 'statistical', 'wavelet' / multiple domains: ["time_domain", "frequency"] / order is not important
